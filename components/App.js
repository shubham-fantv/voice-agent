    ...
    <div className={className}>
      ...
      {!microphone ? (
        ...
        <Fragment>
          ...
          {socketState === 0 && (
            <div className="text-base text-gray-25 text-center w-full">Loading VOIZY...</div>
          )}
          ...
          {/* Transcript Section */}
          <div
            className={`${messages.length <= 0 ? "h-1" : "h-20 md:h-12"} text-sm md:text-base mt-2 flex flex-col items-center text-gray-200 overflow-y-auto`}
          >
